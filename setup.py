...
def create_config_file():
    ...
    print(f"   Edit {config_file} and replace 'your_discord_bot_token_here' with your actual bot token.")
...
def display_next_steps():
    ...
    print("🐛 For issues, visit: https://github.com/yourusername/discord-scheduled-channel-manager/issues")
